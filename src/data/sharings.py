...
def find_most_recent_issue_sharings(dataset_directory_path, verbose=True):
    """Find issue sharings from most recent snapshot in DevGPT dataset

    :param Path dataset_directory_path: path to directory with DevGPT dataset
    :param bool verbose: whether to print debugging-like information,
        `true` by default
    :return: path to most recent issue sharings file,
        for example 'snapshot_20231012/20231012_235128_issue_sharings.json'
    :rtype: Path
    """
